...
public class AnimationSet {
	...
	public AnimationSet(Animation standNorths, Animation walkNorth, Animation walkSouth, Animation walkEast, Animation walkWest, TextureRegion standNorth, TextureRegion standSouth, TextureRegion standEast, TextureRegion standWest) {
		...
		walking.put(DIRECTION.STAND, standNorths);
